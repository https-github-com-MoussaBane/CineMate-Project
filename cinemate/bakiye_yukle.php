...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <article class="card-body mx-auto" style="max-width: 400px;">
        <form action="para_yukle.php" method="POST">
                  <!-- form-group// -->
                  <div class="form-group input-group">
                     <div class="input-group-prepend">
                        <span class="input-group-text"> <ion-icon name="person"></ion-icon></i> </span>
                     </div>
                     <input name="ad" class="form-control" placeholder="Kart Numarası" type="text">
                  </div>  
                  <!-- form-group// -->
                  <div class="form-group input-group">
                     <div class="input-group-prepend">
                     ...
                     <input name="soyad" class="form-control" placeholder="Güvenlik Kodu" type="text">
                  </div>
                  <!-- form-group// -->
                  <div class="form-group input-group">
                     <div class="input-group-prepend">
                     ...
                     <input name="cep_telefon" class="form-control" placeholder="--" type="text">
                     <input name="cep_telefon" class="form-control" placeholder="--" type="text">
                  </div>
                  <!-- form-group// -->
                  <div class="form-group input-group">
                     ...
                     <input name="para" class="form-control" placeholder="Miktar" type="number">
                  </div>
                  <!-- form-group// -->
                  <div class="form-group">
                     <input type="submit" class="btn btn-danger btn-block" value="YÜKLE"/>
                  </div>                                                                 
               </form>
</article>
    </header>
